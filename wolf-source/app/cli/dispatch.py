...
from app.cli.commands.wolf import (
...
COMMAND_HANDLERS: dict[str, CommandHandler] = {
    ...
    "prepare-game": run_prepare_game_command,
    "dump-text": run_dump_text_command,
    ...
    "audit-runtime": run_audit_runtime_command,
    "restore-runtime": run_restore_runtime_command,
    "make-patch": run_make_patch_command,
